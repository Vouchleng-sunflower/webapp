 <?php
    ...
    $manage_users = getUserByID($_GET['id']);
    ...
    ?>
 <form action="./?page=user/update&id=<?php echo $manage_users->id_user ?>" method="post" class="w-50 mx-auto">
     <h1>Update User ID: <?php echo $manage_users->id_user ?></h1>
     <div class="mb-3">
         <label for="user_label" class="form-label">User Label</label>
         <input type="text" name="user_label" class="form-control <?php echo $user_label_err !== '' ?  'is-invalid' : ' ' ?>" id="username" value="<?php echo isset($_POST['user_label']) ? $_POST['user_label'] : $manage_users->user_label ?>">
         ...
         <div class=" mb-3">
             ...
             <input type="password" name="passwd" placeholder="(optional) input password to update" class="form-control" id="passwd" value="<?php echo isset($_POST['passwd']) ? $_POST['passwd'] : '' ?>">
         </div>
     </div>
